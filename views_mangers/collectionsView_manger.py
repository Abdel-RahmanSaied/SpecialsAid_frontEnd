...
class CollectionsScreen(QtWidgets.QWidget, collections_view.Ui_Form):
    ...
    collectionsIDSignal = pyqtSignal(int)
    ...
    def handleFrameContent(self, data):
        ...
        for id in range(dataCount):
            ...
            self.gridLayout_3.addWidget(frame, id // 5, id % 5)  # Add the frame to the grid layout
    ...
    def setFrameContentData(self, btn, label, data, id):
        ...
        self.threadpool.start(lambda id=id: self.setButtonIcon(btn, data['results'][id]['collection_image']))
