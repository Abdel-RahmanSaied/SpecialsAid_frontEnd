...
"border-radius:5% 5%;")
        ...
        self.back_to_home_btn_2 = QtWidgets.QPushButton(self.frame_2)
        self.back_to_home_btn_2.setMinimumSize(QtCore.QSize(20, 0))
        self.back_to_home_btn_2.setMaximumSize(QtCore.QSize(20, 16777215))
        self.back_to_home_btn_2.setStyleSheet("border-color: rgb(255, 255, 255,0);")
        self.back_to_home_btn_2.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/icons8-back-50.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.back_to_home_btn_2.setIcon(icon)
